...
impl FileDesc {
    ...
    #[cfg(not(any(target_os = "espidf", target_os = "horizon", target_os = "zephyr")))]
    ...
    #[cfg(any(target_os = "espidf", target_os = "horizon", target_os = "zephyr"))]
    pub fn read_vectored(&self, bufs: &mut [IoSliceMut<'_>]) -> io::Result<usize> {
    ...
    #[cfg(any(
        all(target_env = "newlib", not(any(target_os = "espidf", target_os = "horizon", target_os = "zephyr"))),
        target_os = "solaris",
        target_os = "illumos",
        target_os = "emscripten",
        target_os = "fuchsia",
